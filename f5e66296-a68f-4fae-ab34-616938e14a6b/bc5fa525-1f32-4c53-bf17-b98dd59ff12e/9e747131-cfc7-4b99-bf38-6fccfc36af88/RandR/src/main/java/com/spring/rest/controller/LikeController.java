...
import com.spring.rest.modelrequests.LikeRequest;
import com.spring.rest.model.UserAuth;
import com.spring.rest.apiresponse.LikeResponse;
...
@Api(value = "Like Mangment System" , description = "Service used to perform operation on like.", tags = "like")
@RestController
@ExposesResourceFor(LikeController.class)
// @RequestMapping("/Like")
@RequestMapping("/api")
public class LikeController {
    ...
    String url=SolrUrls.LIKE_URL;
    
		
	@ApiOperation(value = "Service used to create Like")
	@StandardApiResponses
	@RequestMapping(value="/like" , method=RequestMethod.POST)
	@ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "create a new Like",
 ...
 , HttpServletResponse response, HttpServletRequest request) {
	       ...
	       try {
			...
			//	like.setID(Utility.getUniqueId());
	          
			
	    	   Like like = ModelMapperUtil.mapCreateRequestToModel(likeRequest,  Like.class);

	            // Call service layer
	            Object apiResponse = commonDocumentService.addDocumentAndExceptionByTemplate( like, url);
	            if (apiResponse instanceof Exception) {
	                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
	                        .body(ErrorResponse.of("internal_error", "Failed to save like"));
	            }
	            return ResponseEntity.status(HttpStatus.CREATED)
	                    .body(new ResponseMessage.Builder("Like created successfully", 201)
	                            .withUserObject(like)
	                            .build());
	           }
	        catch (Exception e) {
...
@ApiOperation(value = "This service used to update Like")
@StandardApiResponses	
...
public ResponseEntity<?> updatelike(
    ...
    try {
         ...
         // ✅ Check for ID in Customers POJO
	        ...
	        Object apiResponse = commonDocumentService.advanceQueryAndExceptionByTemplate("ID:" + likeId, url);
        ...
        commonDocumentService.updateDocumentAndExceptionByTemplate(this.createDoc(like,solrDocument), url);
		
		
	//	commonDocumentService.updateDocumentAndExceptionByTemplate(like, url);
...
public <T> Map<String, Object> createDoc(T payloadObject, SolrDocument solrDocument) {
	...
	@ApiOperation(value = "This service used to search Like by query")
	@StandardApiResponses
	...
	public ModelMap  searchLike(@RequestParam(name = "query", required = true) String query,
	...
	@RequestMapping(value="/searchLikeById" , method=RequestMethod.GET)
...
@ApiOperation(value = "This service delete Like by query")
@StandardApiResponses
@DeleteMapping("/like")
public ResponseEntity<?> deleteLikeByQuery(
    ...
    try {
        ...
        return ResponseEntity.ok(
                new ResponseMessage.Builder("Like deleted successfully with Query", 200)
                        .withQuery(query)
