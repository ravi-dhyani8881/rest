...
public class PublishgraphController {
	...
	@RequestMapping(value="/addPublishgraph" , method=RequestMethod.POST)
	public ModelMap  addPublishgraph(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@RequestMapping(value="/updatePublishgraph" , method=RequestMethod.PUT)
	public ModelMap  updatepublishGraph(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@RequestMapping(value="/searchPublishgraphByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/deletePublishgraphByQuery" , method=RequestMethod.DELETE)
