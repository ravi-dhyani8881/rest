...
public class ApikeyController {
	...
	@RequestMapping(value="/addApikey" , method=RequestMethod.POST)
	public ModelMap  addApikey(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@RequestMapping(value="/updateApikey" , method=RequestMethod.PUT)
	public ModelMap  updateapiKey(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@ApiOperation(value = "This service used to search Apikey by query")
	@RequestMapping(value="/searchApikeyByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/searchApikeyById" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/deleteApikeyByQuery" , method=RequestMethod.DELETE)
