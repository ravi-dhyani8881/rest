...
public class GraphdeploymentsController {
	...
	@RequestMapping(value="/addGraphdeployments" , method=RequestMethod.POST)
	public ModelMap  addGraphdeployments(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@RequestMapping(value="/updateGraphdeployments" , method=RequestMethod.PUT)
	public ModelMap  updategraphDeployments(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@RequestMapping(value="/searchGraphdeploymentsByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/deleteGraphdeploymentsByQuery" , method=RequestMethod.DELETE)
