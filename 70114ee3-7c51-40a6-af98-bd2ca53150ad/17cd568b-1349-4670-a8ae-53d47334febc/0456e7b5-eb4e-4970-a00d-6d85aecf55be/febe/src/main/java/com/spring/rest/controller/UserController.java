...
public class UserController {
	...
	@ApiOperation(value = "Service used to add User")
	@RequestMapping(value="/addUser" , method=RequestMethod.POST)
	public ModelMap  addUser(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	public ModelMap  updateuser(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/deleteUserByQuery" , method=RequestMethod.DELETE)
