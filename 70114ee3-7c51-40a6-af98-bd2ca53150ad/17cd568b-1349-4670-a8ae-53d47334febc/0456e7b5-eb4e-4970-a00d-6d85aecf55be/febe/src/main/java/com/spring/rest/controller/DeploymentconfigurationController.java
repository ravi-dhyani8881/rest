...
public class DeploymentconfigurationController {
	...
	@RequestMapping(value="/addDeploymentconfiguration" , method=RequestMethod.POST)
	public ModelMap  addDeploymentconfiguration(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@RequestMapping(value="/updateDeploymentconfiguration" , method=RequestMethod.PUT)
	public ModelMap  updatedeploymentConfiguration(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@RequestMapping(value="/searchDeploymentconfigurationByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/deleteDeploymentconfigurationByQuery" , method=RequestMethod.DELETE)
