...
public class GraphController {
	...
	public ModelMap  addGraph(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@RequestMapping(value="/updateGraph" , method=RequestMethod.PUT)
	public ModelMap  updategraph(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@RequestMapping(value="/searchGraphByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/deleteGraphByQuery" , method=RequestMethod.DELETE)
