...
public class PublishrestController {
	...
	@RequestMapping(value="/addPublishrest" , method=RequestMethod.POST)
	public ModelMap  addPublishrest(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@RequestMapping(value="/updatePublishrest" , method=RequestMethod.PUT)
	public ModelMap  updatepublishRest(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@RequestMapping(value="/searchPublishrestByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/deletePublishrestByQuery" , method=RequestMethod.DELETE)
