...
public class OrganizationController {
	...
	public ModelMap  addOrganization(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	public ModelMap  updateorganization(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@RequestMapping(value="/searchOrganizationByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/deleteOrganizationByQuery" , method=RequestMethod.DELETE)
