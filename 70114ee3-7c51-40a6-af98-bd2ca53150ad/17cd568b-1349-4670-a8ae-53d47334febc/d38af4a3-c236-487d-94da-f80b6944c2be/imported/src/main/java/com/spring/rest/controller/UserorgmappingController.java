...
public class UserorgmappingController {
	...
	public ModelMap  addUserorgmapping(@RequestBody  UserOrgMapping userOrgMapping
 , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKeyx ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
		
	      ModelMap model = new ModelMap();
	        String Id = ( userOrgMapping.getID() != null && ! userOrgMapping.getID().isEmpty()) ?  userOrgMapping.getID(): Utility.getUniqueId();
	        try {
	            // ✅ Validate API key
	            ...
	            // ✅ Ensure ID is set
	            if ( userOrgMapping.getID() == null ||  userOrgMapping.getID().isEmpty()) {
	            	 userOrgMapping.setID(Id);
	            }
	            // Call service layer
...
@ApiOperation(value = "This service used to update Userorgmapping")
	...
	public ModelMap  updateuserOrgMapping(@RequestBody  UserOrgMapping userOrgMapping, HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKeyx ,
