...
@Api(value = "Productratings Mangment System" , description = "Service used to perform operation on productRatings.", tags = "productRatings")
@RestController
@ExposesResourceFor(ProductratingsController.class)
...
public class ProductratingsController {
    ...
    String url=SolrUrls.PRODUCTRATINGS_URL;
    
		
	@ApiOperation(value = "Service used to add Productratings")
	@RequestMapping(value="/addProductratings" , method=RequestMethod.POST)
	public ModelMap  addProductratings(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@ApiOperation(value = "This service used to update Productratings")
	@RequestMapping(value="/updateProductratings" , method=RequestMethod.PUT)
	public ModelMap  updateproductRatings(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@ApiOperation(value = "This service used to search Productratings by query")
	@RequestMapping(value="/searchProductratingsByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/searchProductratingsById" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@ApiOperation(value = "This service delete Productratings by query")
	@RequestMapping(value="/deleteProductratingsByQuery" , method=RequestMethod.DELETE)
