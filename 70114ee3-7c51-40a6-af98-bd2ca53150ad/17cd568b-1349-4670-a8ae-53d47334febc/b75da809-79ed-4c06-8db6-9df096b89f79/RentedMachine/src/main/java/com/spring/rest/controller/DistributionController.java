...
@Api(value = "Distribution Mangment System" , description = "Service used to perform operation on Distribution.", tags = "Distribution")
@RestController
@ExposesResourceFor(DistributionController.class)
...
public class DistributionController {
    ...
    String url=SolrUrls.DISTRIBUTION_URL;
    
		
	@ApiOperation(value = "Service used to add Distribution")
	@RequestMapping(value="/addDistribution" , method=RequestMethod.POST)
	public ModelMap  addDistribution(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@ApiOperation(value = "This service used to update Distribution")
	@RequestMapping(value="/updateDistribution" , method=RequestMethod.PUT)
	public ModelMap  updateDistribution(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@ApiOperation(value = "This service used to search Distribution by query")
	@RequestMapping(value="/searchDistributionByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/searchDistributionById" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@ApiOperation(value = "This service delete Distribution by query")
	@RequestMapping(value="/deleteDistributionByQuery" , method=RequestMethod.DELETE)
