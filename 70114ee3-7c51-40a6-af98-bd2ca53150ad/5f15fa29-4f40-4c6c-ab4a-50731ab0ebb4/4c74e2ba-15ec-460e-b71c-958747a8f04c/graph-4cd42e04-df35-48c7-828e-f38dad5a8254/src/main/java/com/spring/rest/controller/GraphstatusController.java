...
@Api(value = "Graphstatus Mangment System" , description = "Service used to perform operation on graphStatus.", tags = "graphStatus")
@RestController
@ExposesResourceFor(GraphstatusController.class)
...
public class GraphstatusController {
    ...
    String url=SolrUrls.GRAPHSTATUS_URL;
    
		
	@ApiOperation(value = "Service used to add Graphstatus")
	@RequestMapping(value="/addGraphstatus" , method=RequestMethod.POST)
	public ModelMap  addGraphstatus(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@ApiOperation(value = "This service used to update Graphstatus")
	@RequestMapping(value="/updateGraphstatus" , method=RequestMethod.PUT)
	public ModelMap  updategraphStatus(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@ApiOperation(value = "This service used to search Graphstatus by query")
	@RequestMapping(value="/searchGraphstatusByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/searchGraphstatusById" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@ApiOperation(value = "This service delete Graphstatus by query")
	@RequestMapping(value="/deleteGraphstatusByQuery" , method=RequestMethod.DELETE)
