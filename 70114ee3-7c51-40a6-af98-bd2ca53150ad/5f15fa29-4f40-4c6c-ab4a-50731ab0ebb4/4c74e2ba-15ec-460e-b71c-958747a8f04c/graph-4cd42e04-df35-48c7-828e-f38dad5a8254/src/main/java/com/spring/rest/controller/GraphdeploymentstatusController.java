...
@Api(value = "Graphdeploymentstatus Mangment System" , description = "Service used to perform operation on graphDeploymentStatus.", tags = "graphDeploymentStatus")
@RestController
@ExposesResourceFor(GraphdeploymentstatusController.class)
@RequestMapping("/Graphdeploymentstatus")
public class GraphdeploymentstatusController {
    ...
    String url=SolrUrls.GRAPHDEPLOYMENTSTATUS_URL;
    
		
	@ApiOperation(value = "Service used to add Graphdeploymentstatus")
	@RequestMapping(value="/addGraphdeploymentstatus" , method=RequestMethod.POST)
	public ModelMap  addGraphdeploymentstatus(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@ApiOperation(value = "This service used to update Graphdeploymentstatus")
	@RequestMapping(value="/updateGraphdeploymentstatus" , method=RequestMethod.PUT)
	public ModelMap  updategraphDeploymentStatus(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@ApiOperation(value = "This service used to search Graphdeploymentstatus by query")
	@RequestMapping(value="/searchGraphdeploymentstatusByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/searchGraphdeploymentstatusById" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@ApiOperation(value = "This service delete Graphdeploymentstatus by query")
	@RequestMapping(value="/deleteGraphdeploymentstatusByQuery" , method=RequestMethod.DELETE)
