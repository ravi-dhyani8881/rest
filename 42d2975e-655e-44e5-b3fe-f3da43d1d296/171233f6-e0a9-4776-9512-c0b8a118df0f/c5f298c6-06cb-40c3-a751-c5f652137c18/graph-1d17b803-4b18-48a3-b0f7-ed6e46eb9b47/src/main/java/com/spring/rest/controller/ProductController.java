...
@Api(value = "Product Mangment System" , description = "Service used to perform operation on product.", tags = "product")
@RestController
...
public class ProductController {
    ...
    String url=SolrUrls.PRODUCT_URL;
    
		
	@ApiOperation(value = "Service used to add Product")
	@RequestMapping(value="/addProduct" , method=RequestMethod.POST)
	public ModelMap  addProduct(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@ApiOperation(value = "This service used to update Product")
	@RequestMapping(value="/updateProduct" , method=RequestMethod.PUT)
	public ModelMap  updateproduct(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@ApiOperation(value = "This service used to search Product by query")
	@RequestMapping(value="/searchProductByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@ApiOperation(value = "This service delete Product by query")
	@RequestMapping(value="/deleteProductByQuery" , method=RequestMethod.DELETE)
