...
@Api(value = "Profiles Mangment System" , description = "Service used to perform operation on profiles.", tags = "profiles")
@RestController
@ExposesResourceFor(ProfilesController.class)
...
public class ProfilesController {
    ...
    String url=SolrUrls.PROFILES_URL;
    
		
	@ApiOperation(value = "Service used to add Profiles")
	@RequestMapping(value="/addProfiles" , method=RequestMethod.POST)
	public ModelMap  addProfiles(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@ApiOperation(value = "This service used to update Profiles")
	@RequestMapping(value="/updateProfiles" , method=RequestMethod.PUT)
	public ModelMap  updateprofiles(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@ApiOperation(value = "This service used to search Profiles by query")
	@RequestMapping(value="/searchProfilesByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/searchProfilesById" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@ApiOperation(value = "This service delete Profiles by query")
	@RequestMapping(value="/deleteProfilesByQuery" , method=RequestMethod.DELETE)
