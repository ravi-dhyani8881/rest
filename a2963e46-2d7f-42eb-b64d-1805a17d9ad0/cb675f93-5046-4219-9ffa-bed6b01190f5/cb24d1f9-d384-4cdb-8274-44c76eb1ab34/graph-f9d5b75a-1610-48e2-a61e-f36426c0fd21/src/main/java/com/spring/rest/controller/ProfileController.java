...
@Api(value = "Profile Mangment System" , description = "Service used to perform operation on profile.", tags = "profile")
@RestController
@ExposesResourceFor(ProfileController.class)
...
public class ProfileController {
    ...
    String url=SolrUrls.PROFILE_URL;
    
		
	@ApiOperation(value = "Service used to add Profile")
	@RequestMapping(value="/addProfile" , method=RequestMethod.POST)
	public ModelMap  addProfile(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@ApiOperation(value = "This service used to update Profile")
	@RequestMapping(value="/updateProfile" , method=RequestMethod.PUT)
	public ModelMap  updateprofile(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@ApiOperation(value = "This service used to search Profile by query")
	@RequestMapping(value="/searchProfileByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@ApiOperation(value = "This service delete Profile by query")
	@RequestMapping(value="/deleteProfileByQuery" , method=RequestMethod.DELETE)
