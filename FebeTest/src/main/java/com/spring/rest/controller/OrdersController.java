...
@Api(value = "Orders Mangment System" , description = "Service used to perform operation on orders.", tags = "orders")
@RestController
@ExposesResourceFor(OrdersController.class)
...
public class OrdersController {
    ...
    String url=SolrUrls.ORDERS_URL;
    
		
	@ApiOperation(value = "Service used to add Orders")
	@RequestMapping(value="/addOrders" , method=RequestMethod.POST)
	public ModelMap  addOrders(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@ApiOperation(value = "This service used to update Orders")
	@RequestMapping(value="/updateOrders" , method=RequestMethod.PUT)
	public ModelMap  updateorders(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@ApiOperation(value = "This service used to search Orders by query")
	@RequestMapping(value="/searchOrdersByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/searchOrdersById" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@ApiOperation(value = "This service delete Orders by query")
	@RequestMapping(value="/deleteOrdersByQuery" , method=RequestMethod.DELETE)
