...
@Api(value = "Userorg Mangment System" , description = "Service used to perform operation on userOrg.", tags = "userOrg")
@RestController
@ExposesResourceFor(UserorgController.class)
...
public class UserorgController {
    ...
    String url=SolrUrls.USERORG_URL;
    
		
	@ApiOperation(value = "Service used to create Userorg")
	@StandardApiResponses
	@RequestMapping(value="/userOrg" , method=RequestMethod.POST)
	@ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "create a new Userorg",
 ...
 , HttpServletResponse response, HttpServletRequest request) {
	       ...
	       try {
			...
			//	userOrg.setID(Utility.getUniqueId());
	    	   ...
	    	   UserOrg userOrg = ModelMapperUtil.mapCreateRequestToModel(userOrgRequest,  UserOrg.class);
	            ...
	            if (apiResponse instanceof Exception) {
	                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
	                        .body(ErrorResponse.of("internal_error", "Failed to save userOrg"));
	            }
	            return ResponseEntity.status(HttpStatus.CREATED)
	                    .body(new ResponseMessage.Builder("UserOrg created successfully", 201)
	                            .withUserObject(userOrg)
	                            .build());
	           }
	        catch (Exception e) {
	            e.printStackTrace();
...
@ApiOperation(value = "This service used to update Userorg")
@StandardApiResponses	
@RequestMapping(value="/userOrg" , method=RequestMethod.PUT)
public ResponseEntity<?> updateuserOrg(
        @RequestBody UserOrg userOrg,
    ...
    try {
        ...
        commonDocumentService.updateDocumentAndExceptionByTemplate(this.createDoc(userOrg,solrDocument), url);
		
		
	//	commonDocumentService.updateDocumentAndExceptionByTemplate(userOrg, url);
...
public <T> Map<String, Object> createDoc(T payloadObject, SolrDocument solrDocument) {
	...
	@ApiOperation(value = "This service used to search Userorg by query")
	@StandardApiResponses
	@RequestMapping(value="/userOrg" , method=RequestMethod.GET)
	@ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "User found",
                         content = @Content(mediaType = "application/json",
                         schema = @Schema(implementation = UserOrgResponse.class)))
        })
	public ModelMap  searchUserorg(@RequestParam(name = "query", required = true) String query,
	...
	@RequestMapping(value="/searchUserorgById" , method=RequestMethod.GET)
...
@ApiOperation(value = "This service delete Userorg by query")
@StandardApiResponses
@DeleteMapping("/userOrg")
public ResponseEntity<?> deleteUserorgByQuery(
    ...
    try {
        ...
        return ResponseEntity.ok(
                new ResponseMessage.Builder("Userorg deleted successfully with Query", 200)
                        .withQuery(query)
