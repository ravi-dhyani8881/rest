...
public ResponseEntity<?> updateapiKey(
    ...
    try {
        ...
        commonDocumentService.updateDocumentAndExceptionByTemplate(this.createDoc(apiKey,solrDocument), url);
...
public ResponseEntity<?> deleteApikeyByQuery(
    ...
    try {
        ...
        return ResponseEntity.ok(
                new ResponseMessage.Builder("Apikey deleted successfully with Query", 200)
                        .withQuery(query)
