...
public class OrganizationController {
	...
	@ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "create a new Organization",
 ...
 , HttpServletResponse response, HttpServletRequest request) {
	       ...
	       try {
			...
			//	organization.setID(Utility.getUniqueId());
	    	   ...
	    	   Organization organization = ModelMapperUtil.mapCreateRequestToModel(organizationRequest,  Organization.class);
...
public ResponseEntity<?> updateorganization(
    ...
    try {
        ...
        commonDocumentService.updateDocumentAndExceptionByTemplate(this.createDoc(organization,solrDocument), url);
...
public ResponseEntity<?> deleteOrganizationByQuery(
    ...
    try {
        ...
        return ResponseEntity.ok(
                new ResponseMessage.Builder("Organization deleted successfully with Query", 200)
                        .withQuery(query)
