...
public class EnvironmentController {
	...
	@ApiOperation(value = "Service used to create Environment")
	@StandardApiResponses
	@RequestMapping(value="/environment" , method=RequestMethod.POST)
	@ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "create a new Environment",
...
public ResponseEntity<?> updateenvironment(
    ...
    try {
        ...
        commonDocumentService.updateDocumentAndExceptionByTemplate(this.createDoc(environment,solrDocument), url);
...
public <T> Map<String, Object> createDoc(T payloadObject, SolrDocument solrDocument) {
	...
	public ModelMap  searchEnvironment(@RequestParam(name = "query", required = true) String query,
...
public ResponseEntity<?> deleteEnvironmentByQuery(
    ...
    try {
        ...
        return ResponseEntity.ok(
                new ResponseMessage.Builder("Environment deleted successfully with Query", 200)
                        .withQuery(query)
