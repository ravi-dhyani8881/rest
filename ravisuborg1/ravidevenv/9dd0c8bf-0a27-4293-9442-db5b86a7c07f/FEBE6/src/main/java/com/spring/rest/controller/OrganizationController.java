...
public class OrganizationController {
	...
	public ModelMap  addOrganization(@RequestBody  Organization organization
 , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKeyx ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
		
	      ModelMap model = new ModelMap();
	        String Id = ( organization.getID() != null && ! organization.getID().isEmpty()) ?  organization.getID(): Utility.getUniqueId();
	        try {
	            // ✅ Validate API key
...
@ApiOperation(value = "This service used to update Organization")
	...
	public ModelMap  updateorganization(@RequestBody  Organization organization, HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKeyx ,
	...
	@ApiOperation(value = "This service used to search Organization by query")
	...
	@RequestMapping(value="/searchOrganizationById" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@ApiOperation(value = "This service delete Organization by query")
	...
	//	return model.addAttribute("Message", new ResponseMessage("Content deleted Sucesfully with Query", 200,query,"deleted"));
		return model.addAttribute("Message", new ResponseMessage.Builder("Organization deleted Sucesfully with Query", 200)
																.withQuery(query)
