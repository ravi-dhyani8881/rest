...
public class GraphController {
	...
	@ApiOperation(value = "Service used to create Graph")
...
public ResponseEntity<?> updategraph(
	...
	public ModelMap  searchGraph(@RequestParam(name = "query", required = true) String query,
...
@StandardApiResponses
@DeleteMapping("/graph")
public ResponseEntity<?> deleteGraphByQuery(
    ...
    try {
        ...
        return ResponseEntity.ok(
                new ResponseMessage.Builder("Graph deleted successfully with Query", 200)
                        .withQuery(query)
