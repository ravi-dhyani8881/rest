...
public class UsersettingController {
	...
	public ModelMap  addUsersetting(@RequestBody  UserSetting userSetting
 , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKeyx ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
		
	      ModelMap model = new ModelMap();
	        String Id = ( userSetting.getID() != null && ! userSetting.getID().isEmpty()) ?  userSetting.getID(): Utility.getUniqueId();
	        try {
	            // ✅ Validate API key
	            ...
	            // ✅ Ensure ID is set
	            if ( userSetting.getID() == null ||  userSetting.getID().isEmpty()) {
...
@ApiOperation(value = "This service used to update Usersetting")
	...
	public ModelMap  updateuserSetting(@RequestBody  UserSetting userSetting, HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKeyx ,
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/userSetting" , method=RequestMethod.DELETE)
	...
	//	return model.addAttribute("Message", new ResponseMessage("Content deleted Sucesfully with Query", 200,query,"deleted"));
		return model.addAttribute("Message", new ResponseMessage.Builder("Usersetting deleted Sucesfully with Query", 200)
																.withQuery(query)
