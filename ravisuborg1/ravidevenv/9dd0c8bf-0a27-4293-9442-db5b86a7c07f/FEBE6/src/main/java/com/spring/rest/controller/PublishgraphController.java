...
public class PublishgraphController {
 ...
 , HttpServletResponse response, HttpServletRequest request,
	       ...
	       try {
				...
				publishGraph.setID(Utility.getUniqueId());
	            ...
	            if (apiResponse instanceof Exception) {
	                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
	                        .body(ErrorResponse.of("internal_error", "Failed to save publishGraph"));
	            }
	            return ResponseEntity.status(HttpStatus.CREATED)
	                    .body(new ResponseMessage.Builder("PublishGraph created successfully", 201)
