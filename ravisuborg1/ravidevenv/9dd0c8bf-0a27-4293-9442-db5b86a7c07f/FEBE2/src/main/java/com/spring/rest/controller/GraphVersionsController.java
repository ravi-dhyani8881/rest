...
@Api(value = "GraphVersions Mangment System" , description = "Service used to perform operation on graph_versions.", tags = "graph_versions")
@RestController
...
public class GraphVersionsController {
    ...
    String url=SolrUrls.GRAPH_VERSIONS_URL;
    
		
	@ApiOperation(value = "Service used to add GraphVersions")
	@RequestMapping(value="/addGraphVersions" , method=RequestMethod.POST)
	public ModelMap  addGraphVersions(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@RequestMapping(value="/updateGraphVersions" , method=RequestMethod.PUT)
	public ModelMap  updategraph_versions(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@RequestMapping(value="/searchGraphVersionsByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/deleteGraphVersionsByQuery" , method=RequestMethod.DELETE)
