...
public class UsersController {
	...
	@ApiOperation(value = "Service used to add Users")
	@RequestMapping(value="/addUsers" , method=RequestMethod.POST)
	public ModelMap  addUsers(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	public ModelMap  updateusers(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@RequestMapping(value="/searchUsersByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/deleteUsersByQuery" , method=RequestMethod.DELETE)
