...
@Api(value = "Ravime2 Mangment System" , description = "Service used to perform operation on ravime2.", tags = "ravime2")
@RestController
@ExposesResourceFor(Ravime2Controller.class)
@RequestMapping("/Ravime2")
public class Ravime2Controller {
    ...
    String url=SolrUrls.RAVIME2_URL;
    
		
	@ApiOperation(value = "Service used to add Ravime2")
	@RequestMapping(value="/addRavime2" , method=RequestMethod.POST)
	public ModelMap  addRavime2(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@ApiOperation(value = "This service used to update Ravime2")
	@RequestMapping(value="/updateRavime2" , method=RequestMethod.PUT)
	public ModelMap  updateravime2(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@ApiOperation(value = "This service used to search Ravime2 by query")
	@RequestMapping(value="/searchRavime2ByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/searchRavime2ById" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@ApiOperation(value = "This service delete Ravime2 by query")
	@RequestMapping(value="/deleteRavime2ByQuery" , method=RequestMethod.DELETE)
