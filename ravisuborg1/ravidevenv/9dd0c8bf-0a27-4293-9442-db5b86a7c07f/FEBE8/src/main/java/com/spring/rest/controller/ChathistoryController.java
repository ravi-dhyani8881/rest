...
@Api(value = "Chathistory Mangment System" , description = "Service used to perform operation on chatHistory.", tags = "chatHistory")
@RestController
@ExposesResourceFor(ChathistoryController.class)
...
public class ChathistoryController {
	...
	@ApiOperation(value = "Service used to create Chathistory")
	@StandardApiResponses
	@RequestMapping(value="/chatHistory" , method=RequestMethod.POST)
	@ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "create a new Chathistory",
	    	   ...
	    	   ChatHistory chatHistory = ModelMapperUtil.mapCreateRequestToModel(chatHistoryRequest,  ChatHistory.class);
	            ...
	            if (apiResponse instanceof Exception) {
	                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
	                        .body(ErrorResponse.of("internal_error", "Failed to save chatHistory"));
	            }
	            return ResponseEntity.status(HttpStatus.CREATED)
	                    .body(new ResponseMessage.Builder("ChatHistory created successfully", 201)
	                            .withUserObject(chatHistory)
	                            .build());
	           }
	        catch (Exception e) {
	            e.printStackTrace();
...
@ApiOperation(value = "This service used to update Chathistory")
@StandardApiResponses	
@RequestMapping(value="/chatHistory" , method=RequestMethod.PUT)
public ResponseEntity<?> updatechatHistory(
        @RequestBody ChatHistory chatHistory,
        HttpServletResponse response,
        HttpServletRequest request) {

    String chatHistoryId = null;
    ...
    try {
        ...
        commonDocumentService.updateDocumentAndExceptionByTemplate(this.createDoc(chatHistory,solrDocument), url);
		
		
	//	commonDocumentService.updateDocumentAndExceptionByTemplate(chatHistory, url);

        // ✅ Success Response
        ResponseMessage successResponse = new ResponseMessage.Builder("Content updated Successfully", 200)
                .withID(chatHistoryId)
                .withUserObject(chatHistory)
...
public <T> Map<String, Object> createDoc(T payloadObject, SolrDocument solrDocument) {
	...
	@ApiOperation(value = "This service used to search Chathistory by query")
	@StandardApiResponses
	...
	public ModelMap  searchChathistory(@RequestParam(name = "query", required = true) String query,
	...
	@RequestMapping(value="/searchChathistoryById" , method=RequestMethod.GET)
...
@ApiOperation(value = "This service delete Chathistory by query")
@StandardApiResponses
@DeleteMapping("/chatHistory")
public ResponseEntity<?> deleteChathistoryByQuery(
    ...
    try {
        ...
        return ResponseEntity.ok(
                new ResponseMessage.Builder("Chathistory deleted successfully with Query", 200)
                        .withQuery(query)
