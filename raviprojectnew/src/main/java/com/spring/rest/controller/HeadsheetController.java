...
@Api(value = "Headsheet Mangment System" , description = "Service used to perform operation on headsheet.", tags = "headsheet")
@RestController
@ExposesResourceFor(HeadsheetController.class)
@RequestMapping("/Headsheet")
public class HeadsheetController {
    ...
    String url=SolrUrls.HEADSHEET_URL;
    
		
	@ApiOperation(value = "Service used to add Headsheet")
	@RequestMapping(value="/addHeadsheet" , method=RequestMethod.POST)
	public ModelMap  addHeadsheet(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@ApiOperation(value = "This service used to update Headsheet")
	@RequestMapping(value="/updateHeadsheet" , method=RequestMethod.PUT)
	public ModelMap  updateheadsheet(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@ApiOperation(value = "This service used to search Headsheet by query")
	@RequestMapping(value="/searchHeadsheetByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/searchHeadsheetById" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@ApiOperation(value = "This service delete Headsheet by query")
	@RequestMapping(value="/deleteHeadsheetByQuery" , method=RequestMethod.DELETE)
