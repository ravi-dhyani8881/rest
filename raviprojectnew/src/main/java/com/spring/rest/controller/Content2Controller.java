...
@Api(value = "Content2 Mangment System" , description = "Service used to perform operation on content2.", tags = "content2")
@RestController
@ExposesResourceFor(Content2Controller.class)
...
public class Content2Controller {
    ...
    String url=SolrUrls.CONTENT2_URL;
    
		
	@ApiOperation(value = "Service used to add Content2")
	@RequestMapping(value="/addContent2" , method=RequestMethod.POST)
	public ModelMap  addContent2(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
	...
	@ApiOperation(value = "This service used to update Content2")
	@RequestMapping(value="/updateContent2" , method=RequestMethod.PUT)
	public ModelMap  updatecontent2(@RequestBody Map<String, Object> payload , HttpServletResponse response, HttpServletRequest request,
			@RequestHeader(name="X-API-Key", required=true) String apiKey ,
			@RequestHeader(name="X-USER-ID", required=true) String userId) {
	...
	@ApiOperation(value = "This service used to search Content2 by query")
	@RequestMapping(value="/searchContent2ByQuery" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@RequestMapping(value="/searchContent2ById" , method=RequestMethod.GET)
...
//				 apiDetails=commonDocumentService.advanceSearchDocumentByTemplate(searchCriteria, url);
	...
	@ApiOperation(value = "This service delete Content2 by query")
	@RequestMapping(value="/deleteContent2ByQuery" , method=RequestMethod.DELETE)
